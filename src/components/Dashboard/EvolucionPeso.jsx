...
const EvolucionPeso = ({ EvolucioGlobal }) => {

    const [labelData, setLabelData] = useState([])
    const [evoData, setEvoData] = useState([])
    
    let getId = EvolucioGlobal == undefined ? null : EvolucioGlobal?.id
    ...
    useEffect(() => {
        ...
        axios.get(`http://dietservice.bitjoins.pe/api/evolucion/${getId}`)
            .then(resp => {
                ...
                const nuevoArray = evoNuevaData.map(e => parseInt(e?.peso))
